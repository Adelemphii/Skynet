...
public class CommandConfig implements BaseCommand {
    ...
    public void execute(MessageReceivedEvent event) {
        ...
        Server server = Skynet.getInstance().getForumScraper().getServerStorageUtility().getServer(guild.getIdLong());
    ...
    private boolean determineType(String type, String value, Server server) {
        ServerStorageUtility serverStorageUtility = Skynet.getInstance().getForumScraper().getServerStorageUtility();
